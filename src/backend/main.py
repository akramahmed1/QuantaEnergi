...
from src.backend.models import Base, Trade, ESG, User
from passlib.context import CryptContext
from src.backend.services.trade_service import reconcile_position
from src.backend.services.enhanced_trade_service import TradeLifecycleService
from src.backend.services.risk_service import calculate_var, monte_carlo_var, calculate_enhanced_var
from src.backend.services.ai_service import forecast_price, quantum_optimize_portfolio, forecast_load, ensemble_forecast
from src.backend.services.market_service import market_data_broadcaster, fetch_energy_prices, get_market_volatility
from src.backend.services.geo_risk_service import fetch_geo_risk, get_geo_risk_recommendations
from src.backend.services.compliance_service import ComplianceService, ComplianceFramework
from src.backend.services.esg_service import track_esg
from src.backend.services.integration_service import fetch_erp_data
from src.backend.api.v1 import market_data, monte_carlo_var, real_pnl
from src.backend.core.auth import auth_manager, get_current_user
from src.backend.domains.trading.routers import router as trading_router
from src.backend.domains.risk.routers import router as risk_router
from src.backend.domains.ai_forecasting.services import AIForecastingService
from src.backend.domains.geo_risk.routers import router as geo_risk_router
...
from src.backend.domains.compliance.routers import router as compliance_router
from src.backend.core.trade_engine import TradeEngine
from src.backend.core.risk_calculator import RiskCalculator
import numpy as np
import websockets
